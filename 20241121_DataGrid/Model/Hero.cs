...
namespace _20241121_DataGrid.Model
{
    public class Hero
    {
        ...
        public static List<Hero> GetListOfHeroes()
        {
            if (heroes == null)
            {
                ...
                heroes.Add(new Hero("Chill", false, "Simplemente esta chill de cojones", "https://www.excelsior.com.mx/media/pictures/2024/11/21/3216015.jpg", Team.GetListOfTeams()[1]));
        ...
        public List<string> AlterEgos { get
            {
                return new List<string>() {"Paco", "The butano man", "XXXX", "Chill de cojones" };
            }
        }
